...
public class AnalysisVideoIntelModel extends BaseModel {
    ...
    public static AnalysisVideoIntelModel getById(String sId) { return BaseModel.getById(AnalysisVideoIntelModel.class, sId); }
    public static AnalysisVideoIntelModel getById(long id) {
        return BaseModel.getById(AnalysisVideoIntelModel.class, id);
    }
    public static AnalysisVideoIntelModel getByKey(DatastoreKey key) { return BaseModel.getByKey(AnalysisVideoIntelModel.class, key); }
}
