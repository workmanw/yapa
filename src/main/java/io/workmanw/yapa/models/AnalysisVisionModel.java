...
public class AnalysisVisionModel extends BaseModel {
    ...
    protected JsonArray visionItemsToJson(List<VisionItem> models) {
        ...
        if (models != null) {
            for (VisionItem visionLabel : models) {
    ...
    public static AnalysisVisionModel getById(String sId) { return BaseModel.getById(AnalysisVisionModel.class, sId); }
    public static AnalysisVisionModel getById(long id) {
        return BaseModel.getById(AnalysisVisionModel.class, id);
    }
    public static AnalysisVisionModel getByKey(DatastoreKey key) { return BaseModel.getByKey(AnalysisVisionModel.class, key); }
}
